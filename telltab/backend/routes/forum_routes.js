...
router.put('/forum/edit/:id', forum_controller.editForum);
...
router.put('/bucket/edit/:id', bucket_controller.editBucket);
...
router.put('/newrelease/edit/:id', newrelease_controller.editNewRelease);
...
router.put('/post/edit/:id', post_controller.editPost);
router.delete('/post/delete/:id', post_controller.deletePost);
router.put('/post/add_visibility/:id', post_controller.addVisibility);
router.put('/post/remove_visibility/:id', post_controller.removeVisibility);
router.put('/post/add_tag/:id', post_controller.addTag);
router.put('/post/delete_tag/:id', post_controller.deleteTag);
router.put('/post/assign_post/:id', post_controller.assignPost);
router.put('/post/deassign_post/:id', post_controller.deassignPost);
router.put('/post/add_requirement/:id', post_controller.addRequirement);
router.put('/post/delete_requirement/:id', post_controller.deleteRequirement);
