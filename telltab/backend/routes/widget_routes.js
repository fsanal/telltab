...
router.put('/form/add/form_element', form_controller.addFormElement);
router.put('/form/delete/form_element', form_controller.deleteFormElement);
...
router.put('/widget/add_embeddable', widget_controller.addEmbeddable);
router.put('/widget/delete_embeddable', widget_controller.deleteEmbeddable);
